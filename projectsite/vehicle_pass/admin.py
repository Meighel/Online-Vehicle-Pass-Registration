...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('corporate_email', 'firstname', 'middlename', 'lastname', 'suffix', 'college', 'program', 'year_level', 'workplace', 'contact', 'role', 'school_role')
    ...
    fieldsets = (
        ...
        ('Student Information', {
            'fields': ('college', 'program', 'year_level'),
            'classes': ('collapse',),
        }),
