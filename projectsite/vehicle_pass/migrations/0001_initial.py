# Generated by Django 5.1.2 on 2025-09-16 08:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_level', models.CharField(blank=True, choices=[('first year', 'First Year'), ('second year', 'Second Year'), ('third year', 'Thord Year'), ('fourth year', 'Fourth year'), ('fifth year', 'Fifth Year')], max_length=40, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='final_approval', to='vehicle_pass.securityprofile')),
                ('initial_approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='initial_approval', to='vehicle_pass.securityprofile')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vehicle_pass.userprofile')),
