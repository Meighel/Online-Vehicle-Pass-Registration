# Generated by Django 5.1.2 on 2025-09-16 07:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_level', models.CharField(blank=True, choices=[('first year', 'First Year'), ('second year', 'Second Year'), ('third year', 'Thord Year'), ('fourth year', 'Fourth year'), ('fifth year', 'Fifth Year')], max_length=20, null=True)),
                ('father_name', models.CharField(blank=True, max_length=100, null=True)),
                ('father_contact', models.CharField(blank=True, max_length=14, null=True)),
                ...
                ('mother_contact', models.CharField(blank=True, max_length=14, null=True)),
                ...
                ('guardian_contact', models.CharField(blank=True, max_length=14, null=True)),
                ...
                ('school_role', models.CharField(blank=True, choices=[('student', 'Student'), ('faculty & staff', 'Faculty and Staff'), ('university official', 'University Official')], max_length=20, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('no application', 'No Application'), ('application submitted', 'Application Submitted'), ('initial approval', 'Waiting for Approval by OIC'), ('final approval', 'Waiting for Final Approval by GSO - Director'), ('approved', 'Approved'), ('sticker released', 'Vehicle Pass Sticker Released'), ('rejected', 'Rejected')], default='no application', max_length=85)),
                ...
                ('final_approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='final_approved_registration', to='vehicle_pass.securityprofile')),
                ('initial_approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='initial_approved_registration', to='vehicle_pass.securityprofile')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vehicle_pass.userprofile')),
