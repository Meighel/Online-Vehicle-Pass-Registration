...
def login_view(request):
    if request.method == "POST":
        ...
        user = authenticate(request, corporate_email=email, password=password)
...
def redirect_user_dashboard(user):
    # Automatically redirect users to their respective dashboard.
...
def security_dashboard(request):
    return render(request, "dashboards/security.html")
