...
path("dashboard/cashier/cashier_payments/", cashierViewPayment.as_view(), name="cashier_payments"),    path("dashboard/cashier/cashier_transactions/", cashier_transaction, name="cashier_transactions"),
