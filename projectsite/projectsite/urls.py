...
from vehicle_pass.views import (
    ...
    admin_dashboard, AdminViewUser, adminViewPayment, AdminCreateUser, AdminUpdateUser, admin_transaction, admin_manage_application, admin_manage_passes, admin_report,
    home
)
